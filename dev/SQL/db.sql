...
VALUES(2, 'Насколько удобно вам было оформлять заказ?', 2);

insert into QUESTION(QUESTIONNAIRE_ID, text, ANSWER_TYPE)
VALUES(2, 'Напишите что Вам понравилось, а что нет', 1);

insert into QUESTIONNAIRE(name) VALUES('Регистрация');

insert into QUESTION(QUESTIONNAIRE_ID, text, ANSWER_TYPE)
VALUES(3, 'Насколько удобно вам было регистрироваться?', 2);
